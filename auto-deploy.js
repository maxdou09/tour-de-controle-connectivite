...
Usage:
  node auto-deploy.js YOUR_GITHUB_TOKEN
...
Obtenir un token:
  ...
  5. Copiez le token
  6. Exécutez: node auto-deploy.js YOUR_TOKEN
    `);
    process.exit(1);
}
...
async function main() {
    try {
        ...
        console.log('');
        console.log('📝 Étape 4 : Création du commit...');
        ...
        try {
            ...
            console.log('   ℹ️  Commit automatique (fichiers uploadés directement)');
        }
